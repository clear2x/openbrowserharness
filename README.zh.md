...
<p align="center">
  <img src="docs/assets/sidepanel-task.jpg" width="560" alt="真实任务执行中：agent 打开维基百科的 Google Chrome 条目并在侧边栏给出三点总结"><br>
  <em>真实任务执行中：「打开维基百科的 Google Chrome 条目，提炼三个要点」——agent 自主浏览、提取正文，总结直接落入侧边栏。</em>
</p>
