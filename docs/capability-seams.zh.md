...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.browser` | `seam` | [`browser`](../packages/browser/browser) | [`browser`](../packages/browser/browser) | [`tool-browser`](../packages/browser/tool-browser) | - | 适配器注册基于 CDP 的标签页驱动；page_* 与 tabs_* 工具调用这些提供方无关的操作。 |
