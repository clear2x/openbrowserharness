...
| [browser.md](browser.md) | the fork's browser capability seam: the `ctx.browser` provider registry and operation facade behind the extension's `tabs_*`/`page_*` model tools |
